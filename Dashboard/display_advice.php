...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
         <!--  <div class="col-sm-6">
            <h1>Display Advice Details</h1>
          </div> -->
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Display Advice Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">View Advice Details List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div id="load"></div>
              ...
              <div class="m-3">
                <button onclick="location.href='add_advice.php'" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add</button>&nbsp;
  ...
  <!-- /.content-wrapper -->
  <!-- Display Value -->
  <input type="hidden" id="display" value="Display_Advice_All">
  <input type="hidden" id="delete_" value="Delete_Advice_">
  <input type="hidden" id="export_brand" value="export_advice.php">
 <?php
