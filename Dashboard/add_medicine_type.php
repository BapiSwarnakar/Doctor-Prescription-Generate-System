        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Add Medicine Type </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <label class="float-sm-right"><a href="display_medicine_type.php" class="btn btn-warning btn-sm">View Medicine Type</a><br></label>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <div class="card-footer">
                 <div class="form-group d-flex justify-content-center">
                    <input type="hidden" name="page" value="Add_Medicine_Type">
                    <input type="hidden" name="action" value="Add_Medicine_Type">
                    <input type="submit" id="submit" class="btn btn-primary btn-sm" value="Add Product">
                  </div>
                </div>
                <!-- /.card-body -->
