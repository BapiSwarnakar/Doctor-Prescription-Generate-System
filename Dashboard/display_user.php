...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Display User/Retailer</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Display User/Retailer</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="m-3">
                <button onclick="location.href='add_user.php'" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add</button>&nbsp;
  ...
  <!-- /.content-wrapper -->
  <!-- Display Value -->
  <input type="hidden" id="display" value="Display_User_All">
  <input type="hidden" id="delete_" value="Delete_User_">
  <input type="hidden" id="export_brand" value="export_user.php">
  <input type="hidden" id="status_update" value="Update_User_Status">
 <?php
