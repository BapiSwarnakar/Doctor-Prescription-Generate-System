  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <!-- <div class="col-sm-6">
            <h1>Display Patients List</h1>
          </div> -->
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Display Pending Patients List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Display Pending Patients List</h3>
              </div>
              <!-- /.card-header -->
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <!-- /.content-wrapper -->
<!-- <input type="hidden" id="display" value="Display_Patient_All"> -->
<input type="hidden" id="status_update" value="Patient_Visited_Status_">
<input type="hidden" id="page" value="Display_Pending_Patient_All">
<input type="hidden" id="delete_" value="Delete_Patient_">
<input type="hidden" id="export_brand" value="export_patient.php">
 <?php
