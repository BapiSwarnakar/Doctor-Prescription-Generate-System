  ...
  <div class="content-wrapper">
    ...
    <!-- <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Display Old Patient List</h1>
          </div>
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item active">Display Old Patient List</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"> Display Old Patient List</h3>
              </div>
              <!-- /.card-header -->
                  ...
                  <div class="form-group" style="display: none;">
                    <label>Docor Checking
                      <select class="form-control form-control-sm" name="status" id="status">
                        ...
                        ?>
                        <option value="All" <?php echo $two; ?>>All</option>
                        <option value="1" <?php echo $one; ?>>Pending</option>
                        <option value="2" <?php echo $all; ?>>Success</option>
...
<input type="hidden" id="page" value="Display_Patient_old_All">
<input type="hidden" id="delete_" value="Delete_Patient_Old_All">
